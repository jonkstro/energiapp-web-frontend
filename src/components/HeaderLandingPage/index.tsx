                        ...
                        <div style={{ justifyContent: "space-around" }}>
                            <ul className="navbar-nav">
                                <li className="nav-item active">
                                    <a className="nav-link" href="/#section2">Sobre <span className="sr-only">(current)</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/#section4">Produtos</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/#section5">Contato</a>
                                </li>
                            </ul>
                        </div>
